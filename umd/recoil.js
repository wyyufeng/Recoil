(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('react-dom'), require('react'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'react-dom', 'react'], factory)
    : ((global = global || self),
      factory((global.Recoil = {}), global.ReactDOM, global.React));
  ...
  var Snapshot = /*#__PURE__*/ (function () {
    function Snapshot(storeState) {
      ...
      _defineProperty(this, 'getNodes_UNSTABLE', function (opt) {
        ...
        if (
          (opt === null || opt === void 0 ? void 0 : opt.isModified) === true
        ) {
          if (
          ...
          function (_state) {
            Tracing$2.trace(
              ...
              function () {
                ...
                if (
                  !((_prevLoadableRef$curr = prevLoadableRef.current) ===
                    null || _prevLoadableRef$curr === void 0
                    ? void 0
  ...
  */
              ...
              for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                ...
                if (
                  ...
                  _prev$atomValues$get === void 0
                    ...
                    ((_next$atomValues$get = next.atomValues.get(key)) ===
                      null || _next$atomValues$get === void 0
                      ? void 0
  ...
  function useRecoilCallback(fn, deps) {
    ...
    return useCallback(
      ...
      deps != null
        ? [].concat(_toConsumableArray(deps), [storeRef])
  ...
  */
  ...
  function selector$1(options) {
    ...
    function haveAsyncDepsChanged(store, state) {
      ...
      return Array.from(oldDepValues).some(function (_ref9) {
        ...
        var _getCachedNodeLoadabl5 = getCachedNodeLoadable(
            store,
            state,
            nodeKey,
          ),
  ...
  function wrapResults(dependencies, results) {
    return Array.isArray(dependencies)
      ...
      : Object.getOwnPropertyNames(dependencies).reduce(function (
          out,
          key,
          idx,
        ) {
