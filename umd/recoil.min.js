!(function (global, factory) {
  ...
  var gkx = require('../util/Recoil_gkx'),
    ...
    recoverableViolation = require('../util/Recoil_recoverableViolation'),
    Tracing = require('../util/Recoil_Tracing'),
    _require = require('./Recoil_FunctionalCore'),
    getDownstreamNodes = _require.getDownstreamNodes,
    getNodeLoadable = _require.getNodeLoadable,
    setNodeValue = _require.setNodeValue,
    saveDependencyMapToStore = require('./Recoil_Graph')
      .saveDependencyMapToStore,
    getNodeMaybe = require('./Recoil_Node').getNodeMaybe,
    _require4 = require('./Recoil_Node'),
    DefaultValue = _require4.DefaultValue,
    RecoilValueNotReady = _require4.RecoilValueNotReady,
    _require5 = require('./Recoil_RecoilValue'),
  ...
  function applyAction(store, state, action) {
    if ('set' === action.type) {
      var recoilValue = action.recoilValue,
        newValue = (function (store, state, _ref2, valueOrUpdater) {
          var key = _ref2.key;
          if ('function' == typeof valueOrUpdater) {
            var current = getNodeLoadable(store, state, key)[1];
            if ('loading' === current.state) throw new RecoilValueNotReady(key);
            if ('hasError' === current.state) throw current.contents;
            return valueOrUpdater(current.contents);
          }
          return valueOrUpdater;
        })(store, state, recoilValue, action.valueOrUpdater),
        _setNodeValue2 = _slicedToArray(
          setNodeValue(store, state, recoilValue.key, newValue),
          2,
        ),
      ...
      var _step,
        _iterator = _createForOfIteratorHelper(writes.entries());
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _step$value = _slicedToArray(_step.value, 2);
          writeLoadableToTreeState(state, _step$value[0], _step$value[1]);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    } else if ('setLoadable' === action.type) {
      writeLoadableToTreeState(state, action.recoilValue.key, action.loadable);
    } else if ('markModified' === action.type) {
      var _key2 = action.recoilValue.key;
      state.dirtyAtoms.add(_key2);
    } else if ('setUnvalidated' === action.type) {
      var _node$invalidate,
        _key3 = action.recoilValue.key,
        unvalidatedValue = action.unvalidatedValue,
        node = getNodeMaybe(_key3);
      null == node ||
  ...
  function writeLoadableToTreeState(state, key, loadable) {
    'hasValue' === loadable.state && loadable.contents instanceof DefaultValue
  ...
  function applyActionsToStore(store, actions) {
    store.replaceState(function (state) {
      ...
      return invalidateDownstreams(store, newState), newState;
    });
  }
  function queueOrPerformStateUpdate(store, action, key, message) {
    if (batchStack.length) {
      var actionsByStore = batchStack[batchStack.length - 1],
        actions = actionsByStore.get(store);
      actions || actionsByStore.set(store, (actions = [])),
        actions.push(action);
    } else
  ...
  function invalidateDownstreams(store, state) {
    var _step4,
      _iterator4 = _createForOfIteratorHelper(
        getDownstreamNodes(store, state, state.dirtyAtoms),
      );
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
        var _getNodeMaybe,
          _getNodeMaybe$invalid,
          key = _step4.value;
        null === (_getNodeMaybe = getNodeMaybe(key)) ||
          void 0 === _getNodeMaybe ||
          null === (_getNodeMaybe$invalid = _getNodeMaybe.invalidate) ||
          void 0 === _getNodeMaybe$invalid ||
  ...
  function setRecoilValue(store, recoilValue, valueOrUpdater) {
    queueOrPerformStateUpdate(
      store,
      {type: 'set', recoilValue: recoilValue, valueOrUpdater: valueOrUpdater},
      recoilValue.key,
      'set Recoil value',
    );
  }
  ...
  module.exports = {
    ...
    getRecoilValueAsLoadable: function (store, _ref) {
      ...
      treeState.version !== storeState.currentTree.version &&
        ...
        treeState.version !==
          (null === (_storeState$previousT = storeState.previousTree) ||
          void 0 === _storeState$previousT
            ? void 0
    ...
    setRecoilValueLoadable: function (store, recoilValue, loadable) {
      if (loadable instanceof DefaultValue)
        return setRecoilValue(store, recoilValue, loadable);
      queueOrPerformStateUpdate(
        store,
        {type: 'setLoadable', recoilValue: recoilValue, loadable: loadable},
        recoilValue.key,
        'set Recoil value',
      );
    },
    markRecoilValueModified: function (store, recoilValue) {
      queueOrPerformStateUpdate(
        store,
        {type: 'markModified', recoilValue: recoilValue},
        recoilValue.key,
        'mark RecoilValue modified',
      );
    },
    setUnvalidatedRecoilValue: function (store, recoilValue, unvalidatedValue) {
      queueOrPerformStateUpdate(
        store,
        {
          type: 'setUnvalidated',
    ...
    subscribeToRecoilValue: function (store, _ref3, callback) {
      var key = _ref3.key,
        componentDebugName =
      ...
      return (
        ...
        nullthrows(storeState.nodeToComponentSubscriptions.get(key)).set(
          subID,
          [
            null != componentDebugName ? componentDebugName : '<not captured>',
            callback,
          ],
        ),
        {
    ...
    applyAtomValueWrites: function (atomValues, writes) {
      var result = atomValues.clone();
      return (
        writes.forEach(function (v, k) {
          'hasValue' === v.state && v.contents instanceof DefaultValue
            ? result.delete(k)
            : result.set(k, v);
        }),
        result
    ...
    batchStart: function () {
      ...
      return (
        ...
        function () {
          var _step3,
            _iterator3 = _createForOfIteratorHelper(actionsByStore);
          try {
            var _loop = function () {
  ...
  var Recoil_RecoilValueInterface = Object.freeze({__proto__: null}),
    Recoil_ReactBatchedUpdates = {
      unstable_batchedUpdates: {
        unstable_batchedUpdates: reactDom.unstable_batchedUpdates,
      }.unstable_batchedUpdates,
    },
    batchStart$1 = Recoil_RecoilValueInterface.batchStart,
    batcher = Recoil_ReactBatchedUpdates.unstable_batchedUpdates,
    Recoil_Batching_setBatcher = function (newBatcher) {
      batcher = newBatcher;
    },
    Recoil_Batching_batchUpdates = function (callback) {
      batcher(function () {
        var batchEnd = function () {};
        try {
          (batchEnd = batchStart$1()), callback();
        } finally {
          batchEnd();
        }
      });
    ...
    mapIterable =
      (require('../util/Recoil_expectationViolation'),
      require('../util/Recoil_mapIterable')),
    nullthrows$1 = require('../util/Recoil_nullthrows'),
    RecoilValueClasses =
      (require('../util/Recoil_recoverableViolation'),
      require('./Recoil_RecoilValue')),
    DefaultValue$1 = function DefaultValue() {
      _classCallCheck(this, DefaultValue);
    },
    DEFAULT_VALUE = new DefaultValue$1(),
    RecoilValueNotReady$1 = (function (_Error) {
  ...
  module.exports = {
    ...
    recoilValuesForKeys: function (keys) {
  ...
  var Recoil_Node = Object.freeze({__proto__: null}),
    React = require('react'),
    _require$1 = require('react'),
    ...
    _require2$1 = require('../core/Recoil_State'),
    ...
    expectationViolation$1 =
      (require('../util/Recoil_CopyOnWrite').mapByDeletingMultipleFromMap,
      require('../util/Recoil_expectationViolation')),
    nullthrows$2 = require('../util/Recoil_nullthrows'),
    Tracing$1 = require('../util/Recoil_Tracing'),
    unionSets = require('../util/Recoil_unionSets'),
    _require4$1 = require('./Recoil_FunctionalCore'),
    ...
    _require5$1 = require('./Recoil_Graph'),
    graph = _require5$1.graph,
    saveDependencyMapToStore$1 = _require5$1.saveDependencyMapToStore,
    cloneGraph = require('./Recoil_Graph').cloneGraph,
    applyAtomValueWrites$1 = require('./Recoil_RecoilValueInterface')
      .applyAtomValueWrites,
    freshSnapshot = require('./Recoil_Snapshot').freshSnapshot;
  ...
  var defaultStore = Object.freeze({
    ...
    stateReplacerIsBeingExecuted = !1;
  function startNextTreeIfNeeded(storeState) {
    ...
    if (null === storeState.nextTree) {
      var version = storeState.currentTree.version,
        nextVersion = getNextTreeStateVersion();
  ...
  var AppContext = React.createContext({current: defaultStore}),
    ...
    MutableSourceContext = React.createContext(null);
  function sendEndOfBatchNotifications(store) {
    var storeState = store.getState(),
      treeState = storeState.currentTree,
      dirtyAtoms = treeState.dirtyAtoms;
    if (dirtyAtoms.size) {
      var _step,
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          ...
          if (dirtyAtoms.has(key)) {
            var _step4,
              _iterator4 = _createForOfIteratorHelper(subscriptions);
            try {
              for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
                var _step4$value = _slicedToArray(_step4.value, 2);
                _step4$value[0];
                (0, _step4$value[1])(store);
              }
            } catch (err) {
              _iterator4.e(err);
            } finally {
      ...
      var _step3,
        _iterator3 = _createForOfIteratorHelper(
          getDownstreamNodes$1(store, treeState, dirtyAtoms),
        );
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          var _key = _step3.value,
            comps = storeState.nodeToComponentSubscriptions.get(_key);
          if (comps) {
            var _step5,
              _iterator5 = _createForOfIteratorHelper(comps);
            try {
              for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
                var _step5$value = _slicedToArray(_step5.value, 2),
                  _step5$value$ =
                    (_step5$value[0], _slicedToArray(_step5$value[1], 2));
                _step5$value$[0];
                (0, _step5$value$[1])(treeState);
              }
            } catch (err) {
              _iterator5.e(err);
            } finally {
      ...
      useEffect(function () {
        Queue.enqueueExecution('Batcher', function () {
          ...
          if (null !== nextTree) {
            ...
            var discardedVersion = nullthrows$2(storeState.previousTree)
              .version;
  ...
  module.exports = {
    ...
    RecoilRoot: function (_ref) {
      var _createMutableSource,
        ...
        createMutableSource =
          null !== (_createMutableSource = React.createMutableSource) &&
          void 0 !== _createMutableSource
            ? _createMutableSource
            : React.unstable_createMutableSource,
        store =
          null != storeProp
            ? storeProp
            : {
                ...
                replaceState: function (replacer) {
                  ...
                  var replaced,
                    nextTree = nullthrows$2(storeState.nextTree);
                  try {
                    (stateReplacerIsBeingExecuted = !0),
                ...
                getGraph: function (version) {
                  ...
                  var newGraph = graph();
                  return graphs.set(version, newGraph), newGraph;
                },
                subscribeToTransactions: function (callback, key) {
                  ...
                  var _id = nextID++;
                  return (
                    nullthrows$2(nodeTransactionSubscriptions.get(key)).set(
                      _id,
                      callback,
                    ),
                    {
                ...
                initializeState({
                  set: function (atom, value) {
                    var state = initial.currentTree,
                      _setNodeValue2 = _slicedToArray(
                        setNodeValue$1(store, state, atom.key, value),
                        2,
                      ),
                      depMap = _setNodeValue2[0],
                      writes = _setNodeValue2[1],
                    ...
                    var _step6,
                      nonvalidatedAtoms = state.nonvalidatedAtoms.clone(),
                      _iterator6 = _createForOfIteratorHelper(writtenNodes);
                    try {
  ...
  var Recoil_RecoilRoot_react = Object.freeze({__proto__: null}),
    AbstractRecoilValue$1 = function AbstractRecoilValue(newKey) {
      _classCallCheck(this, AbstractRecoilValue),
        _defineProperty(this, 'key', void 0),
        (this.key = newKey);
    },
    RecoilState$1 = (function (_AbstractRecoilValue) {
      _inherits(RecoilState, _AbstractRecoilValue);
      var _super = _createSuper(RecoilState);
      function RecoilState() {
        return (
          _classCallCheck(this, RecoilState), _super.apply(this, arguments)
        );
      }
      return RecoilState;
    })(AbstractRecoilValue$1),
    RecoilValueReadOnly$1 = (function (_AbstractRecoilValue2) {
  ...
  var Recoil_RecoilValue = Object.freeze({__proto__: null}),
    concatIterables = require('../util/Recoil_concatIterables'),
    filterIterable = require('../util/Recoil_filterIterable'),
    nullthrows$3 = require('../util/Recoil_nullthrows'),
    batchUpdates$1 = require('./Recoil_Batching').batchUpdates,
    _require2$2 = require('./Recoil_FunctionalCore'),
    getDownstreamNodes$2 = _require2$2.getDownstreamNodes,
    peekNodeInfo = _require2$2.peekNodeInfo,
    graph$1 = require('./Recoil_Graph').graph,
    _require4$2 = require('./Recoil_Node'),
    ...
    _require5$2 = require('./Recoil_RecoilValueInterface'),
    ...
    _require6$1 = require('./Recoil_State'),
    getNextTreeStateVersion$1 = _require6$1.getNextTreeStateVersion,
    makeEmptyStoreState$1 = _require6$1.makeEmptyStoreState,
    Snapshot = (function () {
      function Snapshot(storeState) {
        ...
        _classCallCheck(this, Snapshot),
          ...
          _defineProperty(this, 'getNodes_UNSTABLE', function (opt) {
            if (!0 === (null == opt ? void 0 : opt.isModified)) {
              if (!1 === (null == opt ? void 0 : opt.isInitialized)) return [];
            ...
            var knownAtoms = _this._store.getState().knownAtoms,
              knownSelectors = _this._store.getState().knownSelectors;
            return null == (null == opt ? void 0 : opt.isInitialized)
          ...
          _defineProperty(this, 'getDeps_UNSTABLE', function (recoilValue) {
            ...
            return recoilValuesForKeys$1(null != deps ? deps : []);
          }),
          _defineProperty(this, 'getSubscribers_UNSTABLE', function (_ref2) {
            var key = _ref2.key,
              state = _this._store.getState().currentTree,
              downstreamNodes = filterIterable(
                getDownstreamNodes$2(_this._store, state, new Set([key])),
                function (nodeKey) {
                  return nodeKey !== key;
                },
              );
            return {nodes: recoilValuesForKeys$1(downstreamNodes)};
          }),
          ...
          _defineProperty(
            ...
            (function () {
              var fn,
                _ref4 =
                  ((fn = regeneratorRuntime.mark(function _callee(mapper) {
                    var mutableSnapshot;
                        ...
                        switch ((_context.prev = _context.next)) {
                          ...
                          case 3:
                            return _context.abrupt(
                              'return',
                              cloneSnapshot(
                                mutableSnapshot.getStore_INTERNAL(),
                              ),
                            );
                          case 4:
                          case 'end':
          ...
          (this._store = {
            ...
            getGraph: function (version) {
              ...
              if (graphs.has(version)) return nullthrows$3(graphs.get(version));
  ...
  function cloneStoreState(store, treeState) {
    var bumpVersion =
      ...
      storeState = store.getState(),
      version = bumpVersion ? getNextTreeStateVersion$1() : treeState.version;
    return {
    ...
    function MutableSnapshot(snapshot) {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(_this2), 'reset', function (
          ...
          return batchUpdates$1(function () {
        ...
        _defineProperty(
          ...
          function (values) {
            ...
            batchUpdates$1(function () {
              var _step,
                _iterator = _createForOfIteratorHelper(values.entries());
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                  var _step$value = _slicedToArray(_step.value, 2),
                    k = _step$value[0],
  ...
  module.exports = {
    ...
    freshSnapshot: function (initializeState) {
      var snapshot = new Snapshot(makeEmptyStoreState$1());
      return null != initializeState ? snapshot.map(initializeState) : snapshot;
    },
    cloneSnapshot: cloneSnapshot,
  };
  var Recoil_Snapshot = Object.freeze({__proto__: null}),
    _require$3 = require('react'),
    ...
    _require7$1 = require('../core/Recoil_Snapshot'),
    cloneSnapshot$1 = (_require7$1.Snapshot, _require7$1.cloneSnapshot),
    setByAddingToSet = require('../util/Recoil_CopyOnWrite').setByAddingToSet,
    differenceSets = require('../util/Recoil_differenceSets'),
    expectationViolation$2 = require('../util/Recoil_expectationViolation'),
    filterMap = require('../util/Recoil_filterMap'),
    filterSet = require('../util/Recoil_filterSet'),
    gkx$1 = require('../util/Recoil_gkx'),
    invariant = require('../util/Recoil_invariant'),
    mapMap = require('../util/Recoil_mapMap'),
    mergeMaps = require('../util/Recoil_mergeMaps'),
    _require9 = require('../util/Recoil_mutableSource'),
    mutableSourceExists = _require9.mutableSourceExists,
    useMutableSource = _require9.useMutableSource,
    nullthrows$4 = require('../util/Recoil_nullthrows'),
    recoverableViolation$2 = require('../util/Recoil_recoverableViolation'),
    Tracing$2 = require('../util/Recoil_Tracing'),
    useComponentName = require('../util/Recoil_useComponentName');
  function handleLoadable(loadable, atom, storeRef) {
    ...
    throw 'hasError' === loadable.state
      ? loadable.contents
      : new Error('Invalid value of loadable atom "'.concat(atom.key, '"'));
  }
  function useRecoilValueLoadable(recoilValue) {
    return mutableSourceExists()
      ? (function (recoilValue) {
          var storeRef = useStoreRef$1(),
            getLoadable = useCallback(
              function () {
                var store = storeRef.current,
                  treeState = store.getState().currentTree;
                return getRecoilValueAsLoadable$2(
                  store,
                  recoilValue,
                  treeState,
                );
            ...
            getLoadableWithTesting = useCallback(
              function () {
                return getLoadable();
              },
              [getLoadable],
            ),
            componentName = useComponentName(),
            subscribe = useCallback(
              function (_storeState, callback) {
                var store = storeRef.current;
                return subscribeToRecoilValue$1(
                  store,
                  recoilValue,
                  function () {
                    return Tracing$2.trace(
                      ...
                      function () {
                        ...
                        prevLoadableRef.current.is(newLoadable) || callback();
                      },
                    );
                  },
                  componentName,
            ...
            source = useRecoilMutableSource$1(),
            loadable = useMutableSource(
              source,
              getLoadableWithTesting,
              subscribe,
            ),
            prevLoadableRef = useRef$1(loadable);
          return (
      ...
      : (function (recoilValue) {
          var storeRef = useStoreRef$1(),
            _useState4 = _slicedToArray(useState$1([]), 2),
            forceUpdate = (_useState4[0], _useState4[1]),
            componentName = useComponentName();
          useEffect$1(
            function () {
              var store = storeRef.current,
                storeState = store.getState(),
                subscription = subscribeToRecoilValue$1(
                  store,
                  recoilValue,
                  function (_state) {
                    Tracing$2.trace(
                      ...
                      ? store
                          ...
                          .queuedComponentCallbacks_DEPRECATED.push(
                            Tracing$2.wrap(function () {
                              (prevLoadableRef.current = null), forceUpdate([]);
                            }),
                          )
                      : forceUpdate([]);
                  },
          ...
          var loadable = getRecoilValueAsLoadable$2(
              storeRef.current,
              recoilValue,
            ),
            prevLoadableRef = useRef$1(loadable);
  ...
  function useRecoilValue(recoilValue) {
    ...
    return handleLoadable(
      useRecoilValueLoadable(recoilValue),
      recoilValue,
      storeRef,
    );
  }
  ...
  function externallyVisibleAtomValuesInState(state) {
    var atomValues = state.atomValues.toMap(),
      persistedAtomContentsValues = mapMap(
        filterMap(atomValues, function (v, k) {
          var persistence = getNode$1(k).persistence_UNSTABLE;
          return (
            null != persistence &&
  ...
  function useGotoRecoilSnapshot() {
    ...
    return useCallback(
      function (snapshot) {
        var _storeState$nextTree,
          storeState = storeRef.current.getState(),
          prev =
            null !== (_storeState$nextTree = storeState.nextTree) &&
            void 0 !== _storeState$nextTree
              ? _storeState$nextTree
              : storeState.currentTree,
          next = snapshot.getStore_INTERNAL().getState().currentTree;
        batchUpdates$2(function () {
          for (
            var keysToUpdate = new Set(),
              _i = 0,
              _arr = [prev.atomValues.keys(), next.atomValues.keys()];
            _i < _arr.length;
            _i++
          ) {
            var _step,
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                var _prev$atomValues$get,
                  _next$atomValues$get,
                  key = _step.value;
                (null === (_prev$atomValues$get = prev.atomValues.get(key)) ||
                void 0 === _prev$atomValues$get
                  ? void 0
                  : _prev$atomValues$get.contents) !==
                  (null === (_next$atomValues$get = next.atomValues.get(key)) ||
                  void 0 === _next$atomValues$get
                    ? void 0
      ...
      return useCallback(
        function () {
          ...
          return (
            ...
            ret instanceof Sentinel && invariant(!1),
            ret
          );
        },
      ...
      var previousSubscriptions = useRef$1(new Set()),
        ...
        unsubscribeFrom = useCallback(
          function (key) {
            ...
            sub && (sub.release(), subscriptions.current.delete(key));
          },
          [subscriptions],
        ),
        componentName = useComponentName();
        ...
        useCallback(
          function (store) {
            var previousTree = store.getState().previousTree,
              currentTree = store.getState().currentTree;
            previousTree ||
            ...
            var atomValues = externallyVisibleAtomValuesInState(currentTree),
              ...
              atomInfo = mapMap(nodes$1, function (node) {
                    ...
                    type:
                      null !==
                        (_node$persistence_UNS =
                          null ===
                            (_node$persistence_UNS2 =
                              node.persistence_UNSTABLE) ||
                          void 0 === _node$persistence_UNS2
                            ? void 0
                            : _node$persistence_UNS2.type) &&
                      void 0 !== _node$persistence_UNS
                        ? _node$persistence_UNS
                        : 'none',
                    backButton:
                      null !==
                        (_node$persistence_UNS3 =
                          null ===
                            (_node$persistence_UNS4 =
                              node.persistence_UNSTABLE) ||
                          void 0 === _node$persistence_UNS4
                            ? void 0
                            : _node$persistence_UNS4.backButton) &&
                      void 0 !== _node$persistence_UNS3 &&
                      _node$persistence_UNS3,
                  },
                };
              }),
              modifiedAtoms = filterSet(currentTree.dirtyAtoms, function (k) {
  ...
  var Recoil_Hooks = Object.freeze({__proto__: null}),
    setByAddingToSet$1 = require('../util/Recoil_CopyOnWrite').setByAddingToSet,
    filterIterable$1 = require('../util/Recoil_filterIterable'),
    mapIterable$1 = require('../util/Recoil_mapIterable'),
    _require2$4 = require('./Recoil_Node'),
    getNode$2 = _require2$4.getNode,
    getNodeMaybe$2 = _require2$4.getNodeMaybe,
    recoilValuesForKeys$2 = _require2$4.recoilValuesForKeys,
  ...
  function getDownstreamNodes$3(store, state, keys) {
    for (
      var visitedNodes = new Set(),
        ...
        graph = store.getGraph(state.version),
  ...
  module.exports = {
    getNodeLoadable: function (store, state, key) {
    ...
    cleanUpNode: function (store, key) {
      getNode$2(key).cleanUp(store);
    },
    setUnvalidatedAtomValue_DEPRECATED: function (state, key, newValue) {
      var _node$invalidate,
        node = getNodeMaybe$2(key);
      return (
        null == node ||
          null === (_node$invalidate = node.invalidate) ||
          void 0 === _node$invalidate ||
        ...
        _objectSpread2(
          ...
          {},
          {
            ...
            nonvalidatedAtoms: state.nonvalidatedAtoms
              .clone()
              .set(key, newValue),
    ...
    peekNodeInfo: function (store, state, key) {
      var _graph$nodeDeps$get,
        _storeState$nodeToCom,
        _storeState$nodeToCom2,
        storeState = store.getState(),
        graph = store.getGraph(state.version),
        type = storeState.knownAtoms.has(key)
          ? 'atom'
          : storeState.knownSelectors.has(key)
          ? 'selector'
          : void 0,
        downstreamNodes = filterIterable$1(
      ...
      return {
        ...
        isSet: 'selector' !== type && state.atomValues.has(key),
        isModified: state.dirtyAtoms.has(key),
        type: type,
        deps: recoilValuesForKeys$2(
          null !== (_graph$nodeDeps$get = graph.nodeDeps.get(key)) &&
            void 0 !== _graph$nodeDeps$get
            ? _graph$nodeDeps$get
            : [],
        ),
        subscribers: {
              ...
              (_storeState$nodeToCom =
                null ===
                  (_storeState$nodeToCom2 = storeState.nodeToComponentSubscriptions.get(
                    key,
                  )) || void 0 === _storeState$nodeToCom2
                  ? void 0
                  : _storeState$nodeToCom2.values()) &&
              void 0 !== _storeState$nodeToCom
              ? _storeState$nodeToCom
              : [],
            function (_ref) {
              return {name: _slicedToArray(_ref, 1)[0]};
            },
          ),
        },
      };
  ...
  var peekNodeInfo$2 = Object.freeze({__proto__: null}).peekNodeInfo,
    useStoreRef$2 = Recoil_RecoilRoot_react.useStoreRef;
  var Recoil_useGetRecoilValueInfo = function () {
  ...
  var Recoil_useRecoilBridgeAcrossReactRoots = function () {
    ...
    _require$6 = require('../adt/Recoil_Loadable'),
    ...
    _require2$5 = require('../core/Recoil_Node'),
    DEFAULT_VALUE$3 = _require2$5.DEFAULT_VALUE,
    DefaultValue$2 = _require2$5.DefaultValue,
    registerNode$1 = _require2$5.registerNode,
    isRecoilValue$3 = require('../core/Recoil_RecoilValue').isRecoilValue,
    _require4$4 = require('../core/Recoil_RecoilValueInterface'),
    ...
    expectationViolation$3 =
      (require('../util/Recoil_deepFreezeValue'),
      require('../util/Recoil_expectationViolation')),
    isPromise = require('../util/Recoil_isPromise'),
    nullthrows$5 = require('../util/Recoil_nullthrows'),
    recoverableViolation$3 = require('../util/Recoil_recoverableViolation'),
    selector = require('./Recoil_selector');
  function baseAtom(options) {
    var key = options.key,
      persistence = options.persistence_UNSTABLE,
      defaultLoadable = isPromise(options.default)
        ? loadableWithPromise(
            options.default
              .then(function (value) {
                return (
              ...
              .catch(function (error) {
                throw ((defaultLoadable = loadableWithError(error)), error);
              }),
          )
        : loadableWithValue(options.default),
      cachedAnswerForUnvalidatedValue = void 0,
      cleanupEffectsByStore = new Map();
    function initAtom(store, initState, trigger) {
      if (!store.getState().knownAtoms.has(key)) {
        if (
          (store.getState().knownAtoms.add(key),
          'loading' === defaultLoadable.state)
        ) {
          var notifyDefaultSubscribers = function () {
            var _store$getState$nextT3;
            (null !== (_store$getState$nextT3 = store.getState().nextTree) &&
            void 0 !== _store$getState$nextT3
              ? _store$getState$nextT3
              : store.getState().currentTree
            ).atomValues.has(key) || markRecoilValueModified$1(store, node);
          };
        ...
        if (null != options.effects_UNSTABLE) {
          var _options$effects_UNST,
            _step,
            duringInit = !0,
            setSelf = function (effect) {
              return function (valueOrUpdater) {
                if (duringInit) {
                  var currentValue =
                    initValue instanceof DefaultValue$2 || isPromise(initValue)
                      ? 'hasValue' === defaultLoadable.state
                        ? defaultLoadable.contents
                        : DEFAULT_VALUE$3
                      : initValue;
                  initValue =
                  ...
                  'function' != typeof valueOrUpdater &&
                    (pendingSetSelf = {effect: effect, value: valueOrUpdater}),
                    setRecoilValue$3(
                      store,
                      node,
                      'function' == typeof valueOrUpdater
                        ? function (currentValue) {
                            var newValue = valueOrUpdater(currentValue);
                            return (
                              (pendingSetSelf = {
                                effect: effect,
                                value: newValue,
            ...
            onSet = function (effect) {
              return function (handler) {
                store.subscribeToTransactions(function (currentStore) {
                  ...
                  if (null == newLoadable || 'hasValue' === newLoadable.state) {
                    var _previousTree$atomVal,
                      _pendingSetSelf,
                      _pendingSetSelf2,
                      _newValue =
                        null != newLoadable
                          ? newLoadable.contents
                          : DEFAULT_VALUE$3,
                      oldLoadable =
                        null !==
                          (_previousTree$atomVal = previousTree.atomValues.get(
                            key,
                          )) && void 0 !== _previousTree$atomVal
                          ? _previousTree$atomVal
                          : defaultLoadable,
                      _oldValue =
                        'hasValue' === oldLoadable.state
                          ? oldLoadable.contents
                          : DEFAULT_VALUE$3;
                    ((null === (_pendingSetSelf = pendingSetSelf) ||
                    void 0 === _pendingSetSelf
                      ? void 0
                      : _pendingSetSelf.effect) === effect &&
                      (null === (_pendingSetSelf2 = pendingSetSelf) ||
                      void 0 === _pendingSetSelf2
                        ? void 0
                        : _pendingSetSelf2.value) === _newValue) ||
                      handler(_newValue, _oldValue);
                  }
                  (null === (_pendingSetSelf3 = pendingSetSelf) ||
                  void 0 === _pendingSetSelf3
                    ? void 0
                    : _pendingSetSelf3.effect) === effect &&
                    (pendingSetSelf = null);
                }, key);
              };
            },
            _iterator = _createForOfIteratorHelper(
              null !== (_options$effects_UNST = options.effects_UNSTABLE) &&
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              null != cleanup && cleanupEffectsByStore.set(store, cleanup);
            }
          } catch (err) {
            _iterator.e(err);
          } finally {
        ...
        if (!(initValue instanceof DefaultValue$2)) {
          var _store$getState$nextT4,
            initLoadable = isPromise(initValue)
              ? loadableWithPromise(
                  (function (store, promise) {
                    var wrappedPromise = promise
                      .then(function (value) {
                        ...
                        return (
                          (null ===
                            (_state$atomValues$get = (null !==
                              (_store$getState$nextT = store.getState()
                                .nextTree) && void 0 !== _store$getState$nextT
                      ...
                      .catch(function (error) {
                        ...
                        throw (
                          ((null ===
                            (_state$atomValues$get2 = (null !==
                              (_store$getState$nextT2 = store.getState()
                                .nextTree) && void 0 !== _store$getState$nextT2
                              ? _store$getState$nextT2
                              : store.getState().currentTree
                            ).atomValues.get(key)) ||
                          void 0 === _state$atomValues$get2
                            ? void 0
                            : _state$atomValues$get2.contents) ===
                            wrappedPromise &&
          ...
          initState.atomValues.set(key, initLoadable),
            null === (_store$getState$nextT4 = store.getState().nextTree) ||
              void 0 === _store$getState$nextT4 ||
              _store$getState$nextT4.atomValues.set(key, initLoadable);
        }
      }
    }
    var node = registerNode$1({
      key: key,
      peek: function (_store, state) {
        var _ref, _state$atomValues$get3, _cachedAnswerForUnval;
        return null !==
          (_ref =
            null !== (_state$atomValues$get3 = state.atomValues.get(key)) &&
            void 0 !== _state$atomValues$get3
              ? _state$atomValues$get3
              : null ===
                  (_cachedAnswerForUnval = cachedAnswerForUnvalidatedValue) ||
                void 0 === _cachedAnswerForUnval
              ? void 0
              : _cachedAnswerForUnval[1]) && void 0 !== _ref
          ? _ref
          : defaultLoadable;
      },
      get: function (store, state) {
        ...
        if (state.nonvalidatedAtoms.has(key)) {
          if (null != cachedAnswerForUnvalidatedValue)
      ...
      set: function (store, state, newValue) {
        if ((initAtom(store, state, 'set'), state.atomValues.has(key))) {
          ...
          if ('hasValue' === existing.state && newValue === existing.contents)
        ...
        return (
          (cachedAnswerForUnvalidatedValue = void 0),
          [new Map(), new Map().set(key, loadableWithValue(newValue))]
        );
      },
      cleanUp: function (store) {
        var _cleanupEffectsByStor;
        null === (_cleanupEffectsByStor = cleanupEffectsByStore.get(store)) ||
          void 0 === _cleanupEffectsByStor ||
  ...
  function atom(options) {
    ...
    return isRecoilValue$3(optionsDefault)
      ? (function (options) {
          var base = atom(
            _objectSpread2(
                          ...
                          validator: function (storedValue) {
                            return storedValue instanceof DefaultValue$2
                              ...
                              : nullthrows$5(
                                ...
                                ).validator(storedValue, DEFAULT_VALUE$3);
                          },
                        },
                      ),
          ...
          return selector({
            ...
            get: function (_ref2) {
              var baseValue = (0, _ref2.get)(base);
              return baseValue instanceof DefaultValue$2
                ? options.default
                : baseValue;
            },
            set: function (_ref3, newValue) {
              return (0, _ref3.set)(base, newValue);
            },
            dangerouslyAllowMutability: options.dangerouslyAllowMutability,
          });
        })(
  ...
  module.exports = atom;
  var Recoil_atom = Object.freeze({__proto__: null}),
    cacheWithValueEquality = require('../caches/Recoil_cacheWithValueEquality'),
    _require$7 = require('../core/Recoil_Node'),
  ...
  module.exports = function (options) {
    ...
    return function (params) {
      var _stableStringify,
        cachedAtom = atomCache.get(params);
        ...
        _objectSpread2(
          ...
          {},
          {
            key: ''
              ...
              .concat(
                null !== (_stableStringify = stableStringify(params)) &&
            ...
            effects_UNSTABLE:
              'function' == typeof options.effects_UNSTABLE
  ...
  var Recoil_atomFamily = Object.freeze({__proto__: null}),
    LEAF = Symbol('ArrayKeyedMap'),
    emptyMap = new Map(),
    ArrayKeyedMap = (function () {
      function ArrayKeyedMap(existing) {
        if (
          ...
          existing instanceof ArrayKeyedMap)
        ) {
          var _step,
            _iterator = _createForOfIteratorHelper(existing.entries());
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              var _step$value = _slicedToArray(_step.value, 2),
                k = _step$value[0],
          ...
          var _step2,
            _iterator2 = _createForOfIteratorHelper(existing);
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
              var _step2$value = _slicedToArray(_step2.value, 2),
                _k = _step2$value[0],
        ...
        _createClass(ArrayKeyedMap, [
          ...
          },
          {
            ...
            value: function (key, value) {
              ...
              return (
                ks.forEach(function (k) {
                  (next = map.get(k)) || ((next = new Map()), map.set(k, next)),
                    (map = next);
                }),
                next.set(LEAF, value),
                this
  ...
  module.exports = {ArrayKeyedMap: ArrayKeyedMap};
  var ArrayKeyedMap$1 = Object.freeze({__proto__: null}).ArrayKeyedMap;
  var Recoil_cacheWithReferenceEquality = function () {
      return new ArrayKeyedMap$1();
    },
    isPromise$1 = require('./Recoil_isPromise');
  function stringify(x, opt, key) {
    ...
    var _JSON$stringify;
    if ('object' !== _typeof(x))
      return null !== (_JSON$stringify = JSON.stringify(x)) &&
        void 0 !== _JSON$stringify
        ? _JSON$stringify
        : '';
    if (isPromise$1(x)) return '__PROMISE__';
    if (Array.isArray(x))
      return '['.concat(
        x.map(function (v, i) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _step$value = _slicedToArray(_step.value, 2),
            k = _step$value[0],
            v = _step$value[1];
          obj['string' == typeof k ? k : stringify(k, opt)] = v;
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
  ...
  var Recoil_stableStringify = Object.freeze({__proto__: null});
  ...
  function Recoil_gkx(gk) {
    var _gks$get;
    return null !== (_gks$get = gks.get(gk)) && void 0 !== _gks$get && _gks$get;
  }
  ...
  var executionId,
    Recoil_gkx_1 = Recoil_gkx,
    _require$8 = require('../adt/Recoil_Loadable'),
    ...
    cacheWithReferenceEquality$1 = require('../caches/Recoil_cacheWithReferenceEquality'),
    cacheWithValueEquality$2 = require('../caches/Recoil_cacheWithValueEquality'),
    nodeCacheMostRecent = require('../caches/Recoil_nodeCacheMostRecent'),
    treeCacheReferenceEquality = require('../caches/Recoil_treeCacheReferenceEquality'),
    treeCacheValueEquality = require('../caches/Recoil_treeCacheValueEquality'),
    _require2$6 = require('../core/Recoil_FunctionalCore'),
    ...
    saveDependencyMapToStore$2 = require('../core/Recoil_Graph')
      .saveDependencyMapToStore,
    _require4$5 = require('../core/Recoil_Node'),
    ...
    isRecoilValue$4 = require('../core/Recoil_RecoilValue').isRecoilValue,
    AbstractRecoilValue$4 = require('../core/Recoil_RecoilValue')
      .AbstractRecoilValue,
    setRecoilValueLoadable$3 = require('../core/Recoil_RecoilValueInterface')
      .setRecoilValueLoadable,
    isPromise$2 =
      (require('../util/Recoil_deepFreezeValue'),
      require('../util/Recoil_isPromise')),
    nullthrows$6 = require('../util/Recoil_nullthrows'),
    startPerfBlock = require('../util/Recoil_PerformanceTimings')
      .startPerfBlock,
    emptySet$1 = Object.freeze(new Set()),
    dependencyStack = [],
    waitingStores = new Map(),
    getNewExecutionId =
      ((executionId = 0),
      function () {
        return executionId++;
  ...
  module.exports = function (options) {
    ...
    function getExecutionInfo(store) {
      return (
        ...
        nullthrows$6(executionInfoMap.get(store))
      );
    }
    ...
    function notifyStoreWhenAsyncSettles(store, loadable, executionId) {
      if ('loading' === loadable.state) {
        ...
        null == stores && waitingStores.set(executionId, (stores = new Set())),
          stores.add(store);
      }
    }
    function getCachedNodeLoadable(store, state, key) {
      ...
      var loadable = _slicedToArray(getNodeLoadable$2(store, state, key), 2)[1],
        isKeyPointingToSelector = store.getState().knownSelectors.has(key);
      return (
        'loading' !== loadable.state &&
          isKeyPointingToSelector &&
          state.atomValues.set(key, loadable),
        [new Map(), loadable]
      );
    }
    function wrapPendingDependencyPromise(
      ...
      return promise
        .then(function (resolvedDep) {
          ...
          var _evaluateSelectorGett2 = _slicedToArray(
              evaluateSelectorGetter(store, state, executionId),
              2,
            ),
          ...
          return 'hasValue' === loadable.state
            ? {__value: loadable.contents, __key: key}
            : loadable.contents;
        })
        .catch(function (error) {
    ...
    function setLoadableInStoreToNotifyDeps(store, loadable, executionId) {
      isLatestExecution(store, executionId) &&
        ...
        (function (newLoadable, executionId) {
          var stores = waitingStores.get(executionId);
          if (void 0 !== stores) {
            var _step,
              _iterator = _createForOfIteratorHelper(stores);
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done; ) {
    ...
    function setDepsInStore(store, state, deps, executionId) {
      var _store$getState,
        ...
        _store$getState$nextT,
        _store$getState3,
        _store$getState3$next;
      (isLatestExecution(store, executionId) ||
        state.version ===
          (null === (_store$getState = store.getState()) ||
          void 0 === _store$getState ||
          null === (_store$getState$curre = _store$getState.currentTree) ||
          void 0 === _store$getState$curre
            ? void 0
            : _store$getState$curre.version) ||
        state.version ===
          (null === (_store$getState2 = store.getState()) ||
          void 0 === _store$getState2 ||
          null === (_store$getState2$next = _store$getState2.nextTree) ||
          void 0 === _store$getState2$next
            ? void 0
        ...
        saveDependencyMapToStore$2(
          ...
          null !==
            (_store$getState$nextT =
              null === (_store$getState3 = store.getState()) ||
              void 0 === _store$getState3 ||
              null === (_store$getState3$next = _store$getState3.nextTree) ||
              void 0 === _store$getState3$next
                ? void 0
                : _store$getState3$next.version) &&
    ...
    function setNewDepInStore(store, state, deps, newDepKey, executionId) {
      deps.add(newDepKey), setDepsInStore(store, state, deps, executionId);
    }
    function evaluateSelectorGetter(store, state, executionId) {
      var result,
        loadable,
        endPerfBlock = startPerfBlock(key),
        depValues = new Map(),
        deps = new Set();
      function getRecoilValue(recoilValue) {
        var depKey = recoilValue.key;
        setNewDepInStore(store, state, deps, depKey, executionId);
        var depLoadable = _slicedToArray(
          getCachedNodeLoadable(store, state, depKey),
          2,
        )[1];
        if (
          (depValues.set(depKey, depLoadable), 'hasValue' === depLoadable.state)
        )
            ...
            ? (result = (function (
                ...
                return promise
                  .then(function (value) {
                    ...
                    return (
                      setCache(state, depValuesToDepRoute(depValues), loadable),
                      setLoadableInStoreToNotifyDeps(
                        store,
                        loadable,
                        executionId,
                      ),
                      {__value: value, __key: key}
                    );
                  })
              ...
              })(store, result, state, depValues, executionId).finally(
                endPerfBlock,
              ))
            : endPerfBlock();
      } catch (errorOrDepPromise) {
        isPromise$2((result = errorOrDepPromise))
      ...
      return (
        maybeFreezeLoadableContents(
          (loadable =
            result instanceof Error
              ? loadableWithError$1(result)
              : isPromise$2(result)
              ? loadableWithPromise$1(result)
              : loadableWithValue$1(result)),
        ),
        [loadable, depValues]
      );
    }
    function depValuesToDepRoute(depValues) {
      return Array.from(depValues.entries()).map(function (_ref) {
        ...
        return [_ref2[0], _ref2[1].contents];
      });
    }
    function getValFromRunningNewExecutionAndUpdatedDeps(store, state) {
      var newExecutionId = getNewExecutionId(),
        _evaluateSelectorGett4 = _slicedToArray(
          evaluateSelectorGetter(store, state, newExecutionId),
          2,
        ),
    ...
    function getSelectorValAndUpdatedDeps(store, state) {
      ...
      if (null != cachedVal)
        return setExecutionInfo(cachedVal, store), cachedVal;
      var inProgressExecutionInfo = (function (store, state) {
        var _Array$from$find,
          _ref3 =
            null !==
              (_Array$from$find = Array.from(executionInfoMap.entries()).find(
                function (_ref5) {
                  var executionInfo = _slicedToArray(_ref5, 2)[1];
                  return (
                    null != executionInfo.latestLoadable &&
                    null != executionInfo.latestExecutionId &&
                    !(function (store, state) {
                      var _executionInfo$depVal,
                        _mapOfCheckedVersions,
                        executionInfo = getExecutionInfo(store),
                        oldDepValues =
                          null !==
                            (_executionInfo$depVal =
                              executionInfo.depValuesDiscoveredSoFarDuringAsyncWork) &&
                          void 0 !== _executionInfo$depVal
                            ? _executionInfo$depVal
                            : new Map(),
                        cachedDepValuesCheckedForThisVersion = Array(
                          (null !==
                            (_mapOfCheckedVersions = mapOfCheckedVersions.get(
                              state.version,
                            )) && void 0 !== _mapOfCheckedVersions
                            ? _mapOfCheckedVersions
                            : new Map()
                          ).entries(),
                        ),
                        isCachedVersionSame =
                          ...
                          cachedDepValuesCheckedForThisVersion.length ===
                            oldDepValues.size &&
                          cachedDepValuesCheckedForThisVersion.every(function (
                            _ref7,
                          ) {
                      ...
                      if (
                        ...
                        return !1;
                      return (
                        mapOfCheckedVersions.set(
                          state.version,
                          new Map(oldDepValues),
                        ),
                        Array.from(oldDepValues).some(function (_ref9) {
                          var _ref10 = _slicedToArray(_ref9, 2),
                            nodeKey = _ref10[0],
                            oldVal = _ref10[1],
                            loadable = _slicedToArray(
                              getCachedNodeLoadable(store, state, nodeKey),
                              2,
                            )[1];
                          return (
    ...
    function setExecutionInfo(
      ...
      'loading' === loadable.state
        ? ((executionInfo.depValuesDiscoveredSoFarDuringAsyncWork = depValues),
          ...
          (executionInfo.stateVersion = null == state ? void 0 : state.version))
    ...
    function maybeFreezeLoadableContents(loadable) {
      'loading' !== loadable.state && loadable.contents;
    }
    function setCache(state, cacheRoute, loadable) {
      state.atomValues.set(key, loadable), cache.set(cacheRoute, loadable);
    }
    ...
    function myPeek(store, state) {
      return cache.get(function (nodeKey) {
        ...
        return null == peek ? void 0 : peek.contents;
      });
    }
      ...
      return registerNode$2({
        ...
        set: function (store, state, newValue) {
          ...
          function getRecoilValue(_ref11) {
            ...
            var loadable = _slicedToArray(
              getCachedNodeLoadable(store, state, key),
              2,
            )[1];
            if ('hasValue' === loadable.state) return loadable.contents;
          ...
          function setRecoilState(recoilState, valueOrUpdater) {
            ...
            var newValue =
              'function' == typeof valueOrUpdater
                ...
                : valueOrUpdater;
            _slicedToArray(
              setNodeValue$3(store, state, recoilState.key, newValue),
              2,
            )[1].forEach(function (v, k) {
          ...
          return (syncSelectorSetFinished = !0), [dependencyMap, writes];
        },
        cleanUp: function () {},
  ...
  var Recoil_selector_NEW = Object.freeze({__proto__: null}),
    _require$9 = require('../adt/Recoil_Loadable'),
    ...
    cacheWithReferenceEquality$2 = require('../caches/Recoil_cacheWithReferenceEquality'),
    _require2$7 = require('../core/Recoil_FunctionalCore'),
    ...
    _require3$6 = require('../core/Recoil_Graph'),
    ...
    _require4$6 = require('../core/Recoil_Node'),
    ...
    AbstractRecoilValue$5 = require('../core/Recoil_RecoilValue')
      .AbstractRecoilValue,
    _require6$4 = require('../core/Recoil_RecoilValueInterface'),
    ...
    isPromise$3 =
      (require('../util/Recoil_deepFreezeValue'),
      require('../util/Recoil_isPromise')),
    nullthrows$7 = require('../util/Recoil_nullthrows'),
    startPerfBlock$1 = require('../util/Recoil_PerformanceTimings')
      .startPerfBlock,
  ...
  function cacheKeyFromDepValues(depValues) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var key = _step.value,
          loadable = nullthrows$7(depValues.get(key));
        answer.push(key),
  ...
  module.exports = function (options) {
    ...
    function notifyStoresOfSettledAsync(originalLoadable, newLoadable) {
      ...
      if (void 0 !== stores) {
        var _step2,
          _iterator2 = _createForOfIteratorHelper(stores);
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
    ...
    function getFromCacheOrEvaluate(store, state) {
            ...
            Array.from(currentDeps)
              ...
              .map(function (depKey) {
                var _getNodeLoadable2 = _slicedToArray(
                    getNodeLoadable$3(store, state, depKey),
                    2,
                  ),
      ...
      if (null != cached)
        return (
          ...
          [dependencyMap, cached]
        );
      var _evaluateSelectorFunc = (function (store, state) {
          ...
          function getRecoilValue(_ref) {
            ...
            var _getNodeLoadable4 = _slicedToArray(
                getNodeLoadable$3(store, state, depKey),
                2,
              ),
          ...
          try {
            var loadable,
              output = get({get: getRecoilValue}),
              result = isRecoilValue$5(output)
                ? getRecoilValue(output)
                : output;
            return (
              isPromise$3(result)
                ? (loadable = loadableWithPromise$2(
                    result.finally(endPerfBlock),
                  ))
                : (endPerfBlock(), (loadable = loadableWithValue$2(result))),
              [dependencyMap, loadable, depValues]
            );
          } catch (errorOrDepPromise) {
            var _loadable;
            return (
              ...
              [dependencyMap, _loadable, depValues]
            );
          }
        })(store, state),
      ...
      return (
        ...
        (function (state, cacheKey, loadable) {
          'loading' !== loadable.state ||
            loadable.contents
              .then(function (result) {
                var newLoadable = loadableWithValue$2(result);
                return (
              ...
              .catch(function (error) {
                if (isPromise$3(error)) return error;
            ...
            'loading' !== loadable.state && state.atomValues.set(key, loadable);
        })(state, newCacheKey, loadable),
    ...
    function myPeek(store, state) {
      var _store$getGraph$nodeD2,
        ...
        currentDeps =
          null !==
            (_store$getGraph$nodeD2 = store
              .getGraph(state.version)
              .nodeDeps.get(key)) && void 0 !== _store$getGraph$nodeD2
        ...
        cacheDepValues = new Map(),
        _iterator3 = _createForOfIteratorHelper(depValues.entries());
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          var _step3$value = _slicedToArray(_step3.value, 2),
            depKey = _step3$value[0],
            depValue = _step3$value[1];
          if (null == depValue) return;
      ...
      return registerNode$3({
        ...
        set: function (store, state, newValue) {
          ...
          function getRecoilValue(_ref2) {
            ...
            var _getNodeLoadable6 = _slicedToArray(
                getNodeLoadable$3(store, state, key),
                2,
              ),
          ...
          function setRecoilState(recoilState, valueOrUpdater) {
            ...
            var newValue =
                'function' == typeof valueOrUpdater
                  ...
                  : valueOrUpdater,
              _setNodeValue2 = _slicedToArray(
                setNodeValue$4(store, state, recoilState.key, newValue),
                2,
              ),
  ...
  var Recoil_selector_OLD = Object.freeze({__proto__: null}),
    Recoil_selector = Recoil_gkx_1('recoil_async_selector_refactor')
      ? Recoil_selector_NEW
      : Recoil_selector_OLD,
    nextIndex = 0;
  ...
  var Recoil_readOnlySelector = function (atom) {
    ...
    _require$a = require('../adt/Recoil_Loadable'),
    ...
    gkx$2 = require('../util/Recoil_gkx'),
    isPromise$4 = require('../util/Recoil_isPromise'),
    selectorFamily$2 = require('./Recoil_selectorFamily');
  ...
  function isError(exp) {
    return null != exp && !isPromise$4(exp);
  }
      ...
      get: function (dependencies) {
        return function (_ref2) {
          ...
          if (gkx$2('recoil_async_selector_refactor'))
            return new Promise(function (resolve, reject) {
              var _step2,
                _iterator2 = _createForOfIteratorHelper(exceptions.entries());
              try {
                var _loop = function () {
                  var _step2$value = _slicedToArray(_step2.value, 2),
                    i = _step2$value[0],
                  ...
                  isPromise$4(exp) &&
                    exp
                      .then(function (result) {
                        (results[i] = getValueFromLoadablePromiseResult(
                          result,
                        )),
                          (exceptions[i] = null),
                          resolve(
          ...
          if (gkx$2('recoil_async_selector_refactor'))
            return Promise.all(exceptions).then(function (exceptionResults) {
              return wrapResults(
                dependencies,
                ((syncResults = results),
                (asyncResults = exceptionResults),
                asyncResults.map(function (result, idx) {
                  return void 0 === result ? syncResults[idx] : result;
                })).map(getValueFromLoadablePromiseResult),
              );
              var syncResults, asyncResults;
            });
  ...
  var Recoil_WaitFor = Object.freeze({__proto__: null}),
    batchUpdates$3 = Recoil_Batching_batchUpdates,
    setBatcher$1 = Recoil_Batching_setBatcher,
    DefaultValue$4 = Recoil_Node.DefaultValue,
    RecoilRoot$2 = Recoil_RecoilRoot_react.RecoilRoot,
    isRecoilValue$6 = Recoil_RecoilValue.isRecoilValue,
    freshSnapshot$2 = Recoil_Snapshot.freshSnapshot,
